...
Route::get('/comments/{comment}/confirm_delete', 'CommentController@confirmDeleter');
Route::get('/document_types/{document_type}/confirm_delete', 'DocumentTypeController@confirmDelete');
Route::get('/holders/{holder}/confirm_delete', 'HolderController@confirmDelete');
Route::get('/statuses/{status}/confirm_delete', 'StatusController@confirmDelete');
Route::get('/transactions/{transaction}/confirm_delete', 'TransactionController@confirmDelete');
Route::resources([
